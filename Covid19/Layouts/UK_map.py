...
from Covid19.data.uk_data import get_UK_counties_data
...
def get_uk_map():
    ...
    #   English Counties
    counties_json = r'VerySimpleCounties.json'
    with open(os.path.join(dir_path, r'GeoJSON', counties_json), "r") as read_file:
    ...
    #   UK countries
    countries_json = r'VerysimpleCountries.json'
    with open(os.path.join(dir_path, r'GeoJSON', countries_json), "r") as read_file:
